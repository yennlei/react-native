        ...
        if (null === returnFiber) (didFatal = !0), onUncaughtError(thrownValue);
          ...
          a: {
            ...
            if (
              ...
              do {
                if (13 === value.tag) {
                  ...
                  if (
                    ...
                    null !== current && current.didTimeout)
                  ) {
                    startTimeMs = 10 * (1073741822 - current.timedOutAt);
                    break;
                  }
              ...
              value = returnFiber$jscomp$0;
              do {
                if ((current = 13 === value.tag))
                  void 0 === value.memoizedProps.fallback
                    ? (current = !1)
                    : ((current = value.memoizedState),
                      (current = null === current || !current.didTimeout));
                if (current) {
